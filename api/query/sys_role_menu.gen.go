...
func newRoleMenu(db *gorm.DB, opts ...gen.DOOption) roleMenu {
	...
	_roleMenu.RoleID = field.NewUint(tableName, "role_id")
	_roleMenu.MenuID = field.NewUint(tableName, "menu_id")
...
func (r roleMenuDo) FindByID(id uint) (result model.RoleMenu, err error) {
	...
	generateSQL.WriteString("SELECT * FROM sys_role_menu where id = ? ")
...
func (r roleMenuDo) FindByIDs(ids []uint) (result model.RoleMenu, err error) {
	...
	generateSQL.WriteString("SELECT * FROM sys_role_menu where id in ? ")
...
func (r roleMenuDo) UpdateByID(id uint, field string, value interface{}) (result model.RoleMenu, err error) {
	...
	params = append(params, id)
	generateSQL.WriteString("UPDATE sys_role_menu SET ? = ? where id = ? ")
...
func (r roleMenuDo) DeleteByID(id uint) (result model.RoleMenu, err error) {
	...
	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("DELETE FROM sys_role_menu where id = ? ")
...
func (r roleMenuDo) DeleteByIDs(ids []uint) (result model.RoleMenu, err error) {
	...
	var generateSQL strings.Builder
	params = append(params, ids)
	generateSQL.WriteString("DELETE FROM sys_role_menu where id in ? ")
